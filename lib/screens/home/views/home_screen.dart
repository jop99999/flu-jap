                    ...
                    child: InkWell(
                      ...
                      child: Expanded(
                        ...
                        children: [
                          Expanded(
                            flex: 1,
                              child: Image.network(state.pizzas[i].picture),
                          ),
                          Padding(
                                      ...
                                      Expanded(
                                        ...
                                        child:
                                          Text(
                                            ...
                                            style: TextStyle(fontSize: 10, color: Colors.grey.shade500, fontWeight: FontWeight.w700, decoration: TextDecoration.lineThrough),
                                          ),
                                      ),
                                    ],
                                  ),
